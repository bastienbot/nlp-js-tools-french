...
var nlpToolsFr = new NlpjsTFr({tagTypes: ['art', 'ver', 'nom'], strictness: false, perfLog: true});

var tokenizedWords = nlpToolsFr.tokenize(corpus);
// console.log(tokenizedWords);

var taggedWords = nlpToolsFr.posTag(tokenizedWords);
